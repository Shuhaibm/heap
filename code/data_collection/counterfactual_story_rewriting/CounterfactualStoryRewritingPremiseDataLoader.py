...
# Task 1: Select the rewritten  that better keeps in mind the details provided in the premise sentence (answer.premise)
import csv
from data_collection.DataLoader import DataLoader

class CounterfactualStoryRewritingPremiseDataLoader(DataLoader):
