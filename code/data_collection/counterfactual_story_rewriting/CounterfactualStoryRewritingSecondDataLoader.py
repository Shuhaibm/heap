...
# Task 2: Select the rewritten continuation that better keeps in mind the details provided in the counterfactual sentence (answer.second)

import csv
from data_collection.DataLoader import DataLoader

class CounterfactualStoryRewritingSecondDataLoader(DataLoader):
